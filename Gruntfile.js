module.exports = function (grunt) {
        ...
        connect: {
            devServer: {
                options: {
                    ...
                    //Use connect-rewrite middleware
                    middleware: function (connect, options) {
                        ...
                        middlewares.unshift(function (req, res, next) {
                            ...
                            res.setHeader('Allow','GET,PUT,OPTIONS,DELETE,POST');
    ...
    grunt.registerTask('compile', [
        'less:compile', 'copy:compile_assets', 'copy:extra_templates', 'concat:compile_js', 'uglify', 'index:compile'
    ]);
